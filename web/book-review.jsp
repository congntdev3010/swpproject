    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <body class="bg-light">
                                ...
                                <div class="card mb-4 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="book-review">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label fw-semibold">Số sao <span
                                                        class="text-danger">*</span></label>
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <c:forEach begin="1" end="5" var="star">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="rating"
                                                                id="star${star}" value="${star}" <c:if
                                                                test="${myReview != null && myReview.rating == star}">checked
                            </c:if>
                            required>
                ...
                <c:if
                    test="${not empty sessionScope.user && sessionScope.user.role == 'READER' && !canReview && myReview == null}">
